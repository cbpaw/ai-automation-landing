...
<>
  <head>
    ...
    <title>"Blog Details | Agency Portfolio Template"</title>
  </head>
  <body>
          ...
          <div className="flex flex-wrap justify-center mx-[-16px]">
            <div className="w-full lg:w-8/12 px-4">
              <div>
                ...
                <h2 className="font-bold text-black text-3xl sm:text-4xl leading-tight sm:leading-tight mb-8">10 amazing sites to download stock photos & digital assets for free</h2>
                <div className="flex flex-wrap items-center justify-between pb-4 mb-10 border-b border-[#E9ECF8]">
                    ...
                    <div className="flex items-center mr-10 mb-5">
                      ...
                      <div className="w-full">
                        <h4 className="text-base font-medium text-body-color mb-1">
                          By
                          <a href="javascript:void(0)" className="text-body-color hover:text-primary"> Musharof Chy </a>
                        </h4>
                      </div>
                    </div>
                  ...
                  <div className="mb-5">
                    <span className="bg-primary rounded-full inline-flex items-center justify-center py-2 px-4 font-semibold text-sm text-white"> Design </span>
                  </div>
                </div>
                <div>
                  <p
                  ...
                  >
                    ...
                    <strong className="text-primary"> malesuada </strong> proin libero nunc consequat interdum varius. Quam pellentesque nec nam aliquam sem et tortor consequat. Pellentesque adipiscing
                  ...
                  >
                    ...
                    <span className="text-primary underline"> Amet dictum sit amet justo </span>
                  ...
                  <h3 className="font-bold text-black font-xl sm:text-2xl lg:text-xl xl:text-2xl leading-tight sm:leading-tight lg:leading-tight xl:leading-tight mb-10">
                  ...
                  <ul className="list-disc list-inside text-body-color mb-10">
                    <li className="font-medium text-body-color text-base sm:text-lg lg:text-base xl:text-lg mb-2">Consectetur adipiscing elit in voluptate velit.</li>
                    <li className="font-medium text-body-color text-base sm:text-lg lg:text-base xl:text-lg mb-2">Mattis vulputate cupidatat.</li>
                    <li className="font-medium text-body-color text-base sm:text-lg lg:text-base xl:text-lg mb-2">Vulputate enim nulla aliquet porttitor odio pellentesque</li>
                    <li className="font-medium text-body-color text-base sm:text-lg lg:text-base xl:text-lg mb-2">Ligula ullamcorper malesuada proin</li>
                  </ul>
                  <div className="rounded-sm overflow-hidden p-8 md:p-9 lg:p-8 xl:p-9 bg-primary relative z-10 mb-10">
                    <p className="max-w-[660px] mx-auto text-center text-base text-white italic font-medium">
    ...
    <a
      href="javascript:void(0)"
      className="hidden items-center justify-center bg-primary text-white w-10 h-10 rounded-sm fixed bottom-8 right-8 left-auto z-[999] hover:shadow-signUp transition back-to-top shadow-md"
    >
