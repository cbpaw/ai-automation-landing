      ...
      <div className="container">
        <div className="flex flex-wrap -mx-4">
          <div className="w-full px-4">
            <div className="text-center mx-auto mb-[60px] max-w-[510px]">
              <span className="font-semibold text-lg text-primary mb-2 block"> TEAM </span>
              <h2 className="font-bold text-3xl sm:text-4xl md:text-[40px] text-dark mb-4">Our Awesome Team</h2>
        ...
        <div className="flex flex-wrap justify-center -mx-4">
          <div className="w-full md:w-1/2 xl:w-1/4 px-4">
            <div className="max-w-[370px] w-full mx-auto mb-10">
              <div className="relative rounded-lg overflow-hidden">
                <img src="images/team/image-01.jpg" alt="image" className="w-full" />
                <div className="absolute w-full bottom-5 left-0 text-center">
                  <div className="bg-white relative rounded-lg overflow-hidden mx-5 py-5 px-3">
          ...
          <div className="w-full md:w-1/2 xl:w-1/4 px-4">
            <div className="max-w-[370px] w-full mx-auto mb-10">
              <div className="relative rounded-lg overflow-hidden">
                <img src="images/team/image-02.jpg" alt="image" className="w-full" />
                <div className="absolute w-full bottom-5 left-0 text-center">
                  <div className="bg-white relative rounded-lg overflow-hidden mx-5 py-5 px-3">
                    <h3 className="text-base font-semibold text-dark">Bas Poot </h3>
                    <p className="text-sm text-body-color">AI Engineer</p>
                    <div>
                      <span className="absolute left-0 bottom-0">
                        <svg width="61" height="30" viewBox="0 0 61 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <circle cx="16" cy="45" r="45" fill="#13C296" fillOpacity="0.11" />
          ...
          <div className="w-full md:w-1/2 xl:w-1/4 px-4">
            <div className="max-w-[370px] w-full mx-auto mb-10">
              <div className="relative rounded-lg overflow-hidden">
                <img src="images/team/image-03.jpg" alt="image" className="w-full" />
                <div className="absolute w-full bottom-5 left-0 text-center">
                  <div className="bg-white relative rounded-lg overflow-hidden mx-5 py-5 px-3">
                    <h3 className="text-base font-semibold text-dark">Youri Hille</h3>
                    <p className="text-sm text-body-color">Full Blown Retard</p>
                    <div>
                      <span className="absolute left-0 bottom-0">
                        <svg width="61" height="30" viewBox="0 0 61 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <circle cx="16" cy="45" r="45" fill="#13C296" fillOpacity="0.11" />
          ...
          <div className="w-full md:w-1/2 xl:w-1/4 px-4">
            <div className="max-w-[370px] w-full mx-auto mb-10">
              <div className="relative rounded-lg overflow-hidden">
                <img src="images/team/image-04.jpg" alt="image" className="w-full" />
                <div className="absolute w-full bottom-5 left-0 text-center">
                  <div className="bg-white relative rounded-lg overflow-hidden mx-5 py-5 px-3">
