                ...
                <div className="mb-12">
                  <div className="relative group mb-8 overflow-hidden shadow-service rounded-md">
                    ...
                    <div className="absolute w-full h-full top-0 left-0 bg-primary bg-opacity-[17%] flex items-center justify-center opacity-0 invisible group-hover:opacity-100 group-hover:visible transition">
                      <a
                        href="src/images/portfolio/portfolio-01.jpg"
              ...
              <div className="w-full md:w-1/2 px-4 item graphics web">
                <div className="mb-12">
                  <div className="relative group mb-8 overflow-hidden shadow-service rounded-md">
                    ...
                    <div className="absolute w-full h-full top-0 left-0 bg-primary bg-opacity-[17%] flex items-center justify-center opacity-0 invisible group-hover:opacity-100 group-hover:visible transition">
                      <a
                        href="src/images/portfolio/portfolio-02.jpg"
                        className="glightbox w-10 h-10 flex items-center justify-center bg-primary text-white rounded-full"
                      >
                        <svg
                          width="14"
              ...
              <div className="w-full md:w-1/2 px-4 item app">
                <div className="mb-12">
                  <div className="relative group mb-8 overflow-hidden shadow-service rounded-md">
                    ...
                    <div className="absolute w-full h-full top-0 left-0 bg-primary bg-opacity-[17%] flex items-center justify-center opacity-0 invisible group-hover:opacity-100 group-hover:visible transition">
                      <a
                        href="src/images/portfolio/portfolio-03.jpg"
                        className="glightbox w-10 h-10 flex items-center justify-center bg-primary text-white rounded-full"
                      >
                        <svg
                          width="14"
              ...
              <div className="w-full md:w-1/2 px-4 item graphics web">
                <div className="mb-12">
                  <div className="relative group mb-8 overflow-hidden shadow-service rounded-md">
                    ...
                    <div className="absolute w-full h-full top-0 left-0 bg-primary bg-opacity-[17%] flex items-center justify-center opacity-0 invisible group-hover:opacity-100 group-hover:visible transition">
                      <a
                        href="src/images/portfolio/portfolio-04.jpg"
                        className="glightbox w-10 h-10 flex items-center justify-center bg-primary text-white rounded-full"
                      >
                        <svg
                          width="14"
