...
<html lang="en">
  <head>
    ...
    <title>Portfolio Details | Agency Portfolio Template</title>
  </head>
  <body>
              ...
              >
                <ul class="blcok lg:flex">
                  ...
                  <li class="relative group submenu-item">
                    ...
                    >
                      <a href="portfolio-details.html" class="block text-sm text-black rounded hover:text-primary py-[10px] px-4"> Portfolio Details Page </a>

                      <a href="blog-grids.html" class="block text-sm text-black rounded hover:text-primary py-[10px] px-4"> Blog Grids Page </a>
        ...
        <div class="flex flex-wrap items-center mx-[-16px]">
          <div class="w-full md:w-8/12 lg:w-7/12 px-4">
            <div class="max-w-[570px] mb-12 md:mb-0">
              <h1 class="font-bold text-black text-2xl sm:text-3xl mb-5">Portfolio Details Page</h1>
        ...
        <div class="flex flex-wrap -mx-5">
          <div class="w-full lg:w-8/12 px-5">
            <div>
              <div class="rounded-sm mb-8">
                <img src="images/portfolio/portfolio-details.jpg" alt="image" class="w-full object-cover object-center" />
              </div>
          ...
          <div class="w-full lg:w-4/12 px-5">
            <div class="bg-[#F8F9FF] border border-[#D7DFFF] py-9 px-6 sm:p-9 lg:px-6 xl:px-5 rounded-sm mb-10">
              <h3 class="font-bold text-primary text-[22px] mb-7">Project Info</h3>
              <ul>
                <li class="flex lg:flex-wrap xl:flex-nowrap mb-3">
                  ...
                  <span class="w-full font-medium text-body-color text-base pl-5 lg:pl-0 xl:pl-5"> Branding, Design </span>
                </li>
                <li class="flex lg:flex-wrap xl:flex-nowrap mb-3">
                  <span class="max-w-[90px] w-full font-medium text-black text-base flex justify-between">
                    Date
                  ...
                  <span class="w-full font-medium text-body-color text-base pl-5 lg:pl-0 xl:pl-5"> June, 21, 2024 </span>
                </li>
                <li class="flex lg:flex-wrap xl:flex-nowrap mb-3">
                  <span class="max-w-[90px] w-full font-medium text-black text-base flex justify-between">
                    Tags
                  ...
                  <span class="w-full font-medium text-body-color text-base pl-5 lg:pl-0 xl:pl-5"> Business, Consulting </span>
                </li>
                <li class="flex lg:flex-wrap xl:flex-nowrap mb-3">
                  <span class="max-w-[90px] w-full font-medium text-black text-base flex justify-between">
                    Website
      ...
      <div class="container">
        <div class="flex flex-wrap -mx-4">
          <div class="w-full md:w-1/2 lg:w-4/12 px-4">
            <div class="mb-10">
              <h2 class="font-bold text-white text-[44px] leading-tight mb-5">Let's Talk!</h2>
              <h3 class="font-bold text-white opacity-70 text-2xl mb-2">Contact Info</h3>
              <p class="font-medium text-base text-body-color mb-1">closerpage@email.com</p>
              <p class="font-medium text-base text-body-color mb-1">12 Hilton St, Manchester M1 1JF</p>
              <p class="font-medium text-base text-body-color mb-1">+44 012 34 5678</p>
            </div>
          </div>
          ...
          <div class="w-full md:w-1/2 lg:w-2/12 px-4">
            <div class="mb-10">
              <h3 class="font-semibold text-white text-xl mb-9">News</h3>
              <ul>
                <li>
                  <a href="javascript:void(0)" class="inline-block text-base text-body-color mb-3 hover:text-primary"> Hot Stuff </a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="inline-block text-base text-body-color mb-3 hover:text-primary"> Perfect Place </a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="inline-block text-base text-body-color mb-3 hover:text-primary"> Vintage </a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="inline-block text-base text-body-color mb-3 hover:text-primary"> Products </a>
                </li>
              </ul>
            </div>
          </div>
          <div class="w-full md:w-1/2 lg:w-3/12 px-4">
            <div class="mb-10">
              <h3 class="font-semibold text-white text-xl mb-9">Quick Links</h3>
              <ul>
                <li>
                  <a href="javascript:void(0)" class="inline-block text-base text-body-color mb-3 hover:text-primary"> Style </a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="inline-block text-base text-body-color mb-3 hover:text-primary"> Health </a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="inline-block text-base text-body-color mb-3 hover:text-primary"> Relationship </a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="inline-block text-base text-body-color mb-3 hover:text-primary"> Legal & Privacy </a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="mt-10 pt-12 border-t border-white border-opacity-10">
          <div class="flex items-center justify-center mb-5">
            <a
              href="javascript:void(0)"
              class="flex items-center justify-center w-8 h-8 founded-full mx-2 text-body-color hover:text-primary"
            ...
            <a
              ...
              name="social-link"
            >
              <svg width="32" height="32" viewBox="0 0 32 32" class="fill-current">
                <path
          ...
          <p class="font-medium text-base text-body-color text-center">All rights reserved by © Portfolio creative 2024</p>
        </div>
      </div>
